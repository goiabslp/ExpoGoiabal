          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              ...
              <div className="mt-4 flex flex-col items-center gap-1">
                <p className={`${!loadingData && totalRegistrations >= 26 ? 'text-zinc-500 drop-shadow-[0_0_10px_rgba(100,100,100,0.4)]' : 'text-orange-500 drop-shadow-[0_0_10px_rgba(255,100,0,0.4)]'} tracking-widest uppercase text-sm font-bold`}>
                  {!loadingData && totalRegistrations >= 26 ? 'Inscrições Encerradas' : 'Inscrições Abertas'}
                </p>
                <button
