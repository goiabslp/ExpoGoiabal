      ...
      <main className="flex-1 p-6 lg:p-10 max-w-7xl mx-auto w-full flex flex-col gap-8 animate-in slide-in-from-bottom-8 fade-in duration-700">
        ...
        {view === 'menu' && (
          <div className="z-10 w-full max-w-6xl mt-8 flex flex-col gap-12 animate-in fade-in duration-1000 mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 w-full px-4 mt-6">
              {/* Card 1: Embaixadora */}
              <div 
              ...
              >
                <img 
                  src="/truco.png" 
                  alt="Torneio de Truco" 
                  className="w-3/5 max-w-[260px] aspect-square object-cover rounded-3xl drop-shadow-[0_0_15px_rgba(16,185,129,0.3)] group-hover:drop-shadow-[0_0_30px_rgba(16,185,129,0.6)] transition-all duration-500"
                />
                <span className="mt-5 text-lg font-bold uppercase tracking-widest text-zinc-400 group-hover:text-emerald-400 transition-colors">
                  Torneio de Truco
                </span>
              </div>
            </div>
