/**
 * Lista oficial de municípios do Estado de Minas Gerais (IBGE)
 * Total: 853 municípios
 * Padrão: "São José do Goiabal - MG"
 */

export const CIDADE_PADRAO_MG = 'São José do Goiabal - MG';

export const CIDADES_MINAS_GERAIS: string[] = [
